...
namespace Allocations
{
    public class GetProjectCommand : HystrixCommand<ProjectInfo>
    {
        ...
        public GetProjectCommand(Func<long, Task<ProjectInfo>> getProjectFn, Func<long, Task<ProjectInfo>> getProjectFallbackFn, long projectId) : base(HystrixCommandGroupKeyDefault.AsKey("ProjectClientGroup"))
        {
